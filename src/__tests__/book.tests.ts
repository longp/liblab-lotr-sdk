...
//         const books = await lotr.books.getAll()
...
//         const book = await lotr.books.getById("5cf58080b53e011a64671584")
//         expect(book.docs).toHaveLength(1)
//         expect(book.docs[0].name).toBe('The Return Of The King')
//     })

//     test('Get all chapters in a book', async () => {
//         const chapters = await lotr.books.getChapters('5cf58080b53e011a64671584')
